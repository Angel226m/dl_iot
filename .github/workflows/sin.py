...
"""
═══════════════════════════════════════════════════════════════════════════
CRACKGUARD BACKEND v5.0 - MULTIPART OPTIMIZADO 🚀
...
def rpi_upload_photo():
    ...
    try:
        ...
        # 🚀 GUARDAR DIRECTAMENTE (sin decodificar base64)
        file.save(filepath)
...
print("\n" + "═" * 100)
print("🚀 CRACKGUARD BACKEND v5.0 - MULTIPART OPTIMIZADO")
print("═" * 100)
...
print(f"   • POST /api/predict (multipart)")
print(f"   • GET  /health")
print("═" * 100 + "\n")
...
print("✅ Backend corriendo en 0.0.0.0:5000\n")
