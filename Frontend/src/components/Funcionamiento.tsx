  ...
  const layers = [
    {
      ...
      technology: 'Raspberry Pi 4 + Arducam',
      color: 'from-cyan-500 to-blue-600',
      description: 'Dispositivos IoT para captura de imágenes en tiempo real con soporte para simulaciones y pruebas en vivo',
      features: ['Raspberry Pi 4', 'Cámara de alta resolución (1920x1080)', 'Sensores ambientales', 'Simulación de captura'],
    },
    {
      icon: <Server className="w-10 h-10" />,
      title: 'Capa de Servidor',
      technology: 'Python + Flask + TensorFlow',
      color: 'from-blue-500 to-indigo-600',
      description: 'Procesamiento avanzado con modelos de Deep Learning, TTA y análisis morfológico',
      features: ['API Flask para predicciones', 'Modelo UNet++ EfficientNet-B8', 'TTA (6x)', 'Análisis morfológico', 'Optimización con TensorFlow'],
    },
    {
      icon: <Monitor className="w-10 h-10" />,
      title: 'Capa de Cliente',
      technology: 'React + TypeScript + Tailwind',
      color: 'from-indigo-500 to-cyan-600',
      description: 'Interfaz web responsiva para carga de imágenes, análisis y visualización detallada de resultados',
      features: ['React 18 con hooks', 'TypeScript para tipado seguro', 'Diseño adaptativo', 'Integración con cámara y uploads'],
    },
  ]
      ...
      <section className="relative bg-slate-900 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6">Arquitectura de Tres Capas</h2>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Sistema modular con integración escalable, TTA y análisis morfológico avanzado
            </p>
          </div>
