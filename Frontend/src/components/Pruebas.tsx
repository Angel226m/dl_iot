...
/*
import { useState, useRef, useEffect } from 'react'
import { Camera, Upload, Image as ImageIcon, Zap, CheckCircle, AlertCircle, Loader, XCircle, AlertTriangle, Settings, Wifi, Video, WifiOff, RefreshCw, Globe } from 'lucide-react'
                ...
                {!result ? (
                  <div className="space-y-6">
                    ...
                    <div className="bg-slate-900/50 border border-slate-700 rounded-2xl p-6">
                      ...
                      <ul className="space-y-3 text-slate-300 text-sm">
                        ...
                        <li className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-purple-400 flex-shrink-0 mt-0.5" />
                          <span><strong>Autenticación</strong> con contraseña</span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className={`${getSeveridadBg(result.metricas.severidad)} border rounded-2xl p-6`}>
                      ...
                      <p className="text-sm text-slate-300 mt-1">
                        Confianza: <span className="font-semibold">{(result.metricas.confianza * 100).toFixed(1)}%</span>
                      </p>
                    </div>
