...
const Funcionamiento = () => {
  ...
  const timeline = [
    ...
    { week: 'Semana 3-4', dates: '20 Oct - 02 Nov 2025', activities: ['Configuración de Raspberry Pi', 'Desarrollo backend Flask', 'Recolección de dataset', 'Integración de TTA y análisis morfológico'], responsible: 'Garay, Figueroa', deliverable: 'Prototipo de hardware y API', status: 'Completado' },
    { week: 'Semana 5', dates: '03 Nov - 09 Nov 2025', activities: ['Entrenamiento del modelo UNet++ EfficientNet-B8', 'Optimización de hiperparámetros', 'Validación del modelo con TTA'], responsible: 'Borjas, Conca', deliverable: 'Modelo entrenado', status: 'Completado' },
    { week: 'Semana 6', dates: '10 Nov - 16 Nov 2025', activities: ['Desarrollo del frontend React', 'Integración con backend', 'Diseño de interfaz para pruebas en vivo'], responsible: 'Figueroa, Garay', deliverable: 'Aplicación web funcional', status: 'En Progreso' },
      ...
      <section className="relative bg-slate-950 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Planificación de 7 semanas (06 Oct - 23 Nov 2025) - Actualizado al 11 Nov 2025
            </p>
          </div>
